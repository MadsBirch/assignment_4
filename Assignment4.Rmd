...
ppc_dens_overlay(dm$MeanES, s_m)
...
s_m3 = sim(m3, data = dp2)

ppc_dens_overlay(dp2$PitchSD, s_m3)

# evalutating model quality
waic(m3)
...
prior_c = dnorm(x,mean = 0.6, sd = 0.8)
...
# compare models
WAIC(m3,m4, compare = TRUE)
# why does waic not work on brm models?
